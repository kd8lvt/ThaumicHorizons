...
import com.kentington.thaumichorizons.client.renderer.block.*;
...
import com.kentington.thaumichorizons.client.renderer.tile.*;
...
public class ClientProxy extends CommonProxy {
    ...
    public void registerRenderers() {
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(TileNodeInfuser.class, new TileNodeInfuserRender());
    ...
    public void registerDisplayInformation() {
        ...
        ThaumicHorizons.blockNodeInfuserRI = RenderingRegistry.getNextAvailableRenderId();
        RenderingRegistry.registerBlockHandler(new BlockNodeInfuserRender());
    }
